...
Our strategy is guided by the following principles (as defined in [Constraints and Principals](../constraints-principals.md)):
...
* Execution: Runs on every push to a Pull Request. Stryker runs periodically to validate suite depth.
...
* Execution: Runs on every push to a Pull Request across supported browser matrices. A11y scans are integrated into the E2E steps.
