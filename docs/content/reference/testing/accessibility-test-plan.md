...
Accessibility testing is performed using a combination of:
...
Pages are grouped by functional pattern.
...
Where reusable components are used across multiple pages, accessibility findings are assessed at the component level and spot-checked across implementations.

## Automated accessibility testing

Accessibility issues are identified through automated testing integrated into the application's test suite and CI/CD pipeline.
...
Accessibility scans are executed as part of automated end-to-end tests using Playwright and axe.
...
Accessibility testing is treated as a standard part of the automated regression suite rather than as a separate activity.

### Coverage requirements

Accessibility scans are executed against:
...
Automated test results capture:
...
Results are retained as part of CI/CD artefacts.
...
Verification that all functionality can be completed using only a keyboard is performed.

### Test method

Interaction is restricted to:
...
Mouse interaction is prohibited.
...
- Logical tab order
- Absence of inaccessible controls
...
The entire form journey can be completed using keyboard-only interaction.

## Screen reader testing

Verification that users can understand and complete the application using a screen reader is performed.
...
Verification of accessible identification and recovery from errors is performed.
...
- Affected field is identifiable by the user

Invalid Data:

- Error explanation is provided
...
Verification that focus remains predictable and meaningful is performed.

### Test cases

Page Navigation:

- Focus moves to the page heading or expected content
...
Verification of sufficient visual contrast is performed.
...
Verification of usability at increased zoom levels is performed.
...
- Prohibited horizontal scrolling is absent
...
A manual review is conducted against applicable WCAG 2.2 AA Success Criteria.
...
- Automated Playwright + axe accessibility tests pass
- Accessibility tests execute in CI/CD
