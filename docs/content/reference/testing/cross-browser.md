...
order: 3
---
This reference defines the strategy for introducing cross-browser testing into the existing Playwright E2E automation framework.
...
- Tests can be executed locally against any supported browser.
