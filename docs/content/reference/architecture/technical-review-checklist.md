...
| Structured logging in place with correct context/correlation |   ✅    | [Program.cs](../../../src/Dfe.Acec.Web/Program.cs) (Azure Monitor telemetry integration) and [Deployment Architecture](/reference/architecture/deployment-architecture/#logging)                                        |
