Feature: ExpectedChildDetails ExpectedChildRelationship
...
Scenario: Continue without selection
    ...
    And the error summary title should be "There is a problem" with an error message "Select your expected relationship to the child"
    And inline validation should display with the error message "Select your expected relationship to the child"
