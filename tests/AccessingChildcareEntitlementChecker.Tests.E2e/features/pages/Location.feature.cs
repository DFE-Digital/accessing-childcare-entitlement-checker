...
namespace AccessingChildcareEntitlementChecker.Tests.E2e.Features.Pages
{
    ...
    public partial class LocationFeature : object, global::Xunit.IClassFixture<LocationFeature.FixtureData>, global::Xunit.IAsyncLifetime
    {
        ...
        private static global::Reqnroll.FeatureInfo featureInfo = new global::Reqnroll.FeatureInfo(new global::System.Globalization.CultureInfo("en-US"), "features/pages", "Location", null, global::Reqnroll.ProgrammingLanguage.CSharp, featureTags, InitializeCucumberMessages());
...
#line hidden
        ...
        public LocationFeature(LocationFeature.FixtureData fixtureData, global::Xunit.Abstractions.ITestOutputHelper testOutputHelper)
        {
...
#line hidden
#line 4
    await testRunner.GivenAsync("I am on the \'Where do you live?\' page", ((string)(null)), ((global::Reqnroll.Table)(null)), "Given ");
#line hidden
        }
        
        private static global::Reqnroll.Formatters.RuntimeSupport.FeatureLevelCucumberMessages InitializeCucumberMessages()
        {
            return new global::Reqnroll.Formatters.RuntimeSupport.FeatureLevelCucumberMessages("features/pages/Location.feature.ndjson", 7);
        }
        ...
        [global::Xunit.TraitAttribute("FeatureTitle", "Location")]
...
#line hidden
#line 16
    await testRunner.WhenAsync("I select the \"Scotland\" radio button", ((string)(null)), ((global::Reqnroll.Table)(null)), "When ");
#line hidden
#line 17
    await testRunner.AndAsync("I select the \"England\" radio button", ((string)(null)), ((global::Reqnroll.Table)(null)), "And ");
#line hidden
#line 18
    await testRunner.ThenAsync("the \"England\" radio button should be selected", ((string)(null)), ((global::Reqnroll.Table)(null)), "Then ");
#line hidden
#line 19
...
#line 25
    await testRunner.AndAsync("the error summary title should be \"There is a problem\" with an error message \"Sel" +
                        "ect where you live\"", ((string)(null)), ((global::Reqnroll.Table)(null)), "And ");
#line hidden
#line 26
    await testRunner.AndAsync("inline validation should display with the error message \"Select where you live\"", ((string)(null)), ((global::Reqnroll.Table)(null)), "And ");
#line hidden
            }
            await this.ScenarioCleanupAsync();
        }
...
#line hidden
#line 29
    await testRunner.GivenAsync("I have selected the \"England\" radio button", ((string)(null)), ((global::Reqnroll.Table)(null)), "Given ");
#line hidden
#line 30
    await testRunner.WhenAsync("I click on Continue", ((string)(null)), ((global::Reqnroll.Table)(null)), "When ");
#line hidden
...
#line hidden
#line 35
    await testRunner.ThenAsync("I should be returned to the previous page in the user journey \"Check what help yo" +
                        "u could get with childcare costs\"", ((string)(null)), ((global::Reqnroll.Table)(null)), "Then ");
#line hidden
            }
            await this.ScenarioCleanupAsync();
        }
        ...
        public class FixtureData : object, global::Xunit.IAsyncLifetime
        {
            ...
            async global::System.Threading.Tasks.Task global::Xunit.IAsyncLifetime.InitializeAsync()
            {
                await LocationFeature.FeatureSetupAsync();
            }
            
            async global::System.Threading.Tasks.Task global::Xunit.IAsyncLifetime.DisposeAsync()
            {
                await LocationFeature.FeatureTearDownAsync();
            }
        }
    }
}
