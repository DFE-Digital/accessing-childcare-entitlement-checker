...
Scenario: Continue without selection
    ...
    And the error summary title should be "There is a problem" with an error message "Select is this child has been born"
    And inline validation should display with the error message "Select is this child has been born"
