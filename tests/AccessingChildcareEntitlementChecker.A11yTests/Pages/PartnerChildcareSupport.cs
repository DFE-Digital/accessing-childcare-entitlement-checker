...
public class PartnerChildcareSupportPageAccessibilityTests(ITestOutputHelper output) : PageBase(output)
{
    protected override string PageUrl => "/benefits/childcare-support-partner";
