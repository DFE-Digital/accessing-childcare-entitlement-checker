...
Scenario: Both parents under 18, one parent an apprentice, one parent earning under the threshold
...
Scenario: Single parent who is self employed, child is not born yet
...
Scenario: One parent aged 18-20, child not yet born
...
Scenario: One parent is earning under the threshold, household receives Universal Credit
...
Scenario: One parent on carer's allowance, child receives DLA
...
Scenario: Single parent earning below the threshold, household receives Universal Credit, child is not born yet
...
Scenario: One parent on parental leave
...
Scenario: Single parent on sick leave, parent is a citizen of a different country
...
Scenario: One parent not working, one parent receiving ESA
...
Scenario: Parent is a non-UK national without pre-settled or settled status
...
Scenario: Single parent not working, on carer's allowance
