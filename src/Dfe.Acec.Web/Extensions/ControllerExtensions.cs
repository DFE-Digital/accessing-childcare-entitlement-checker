...
{
    public static RedirectToActionResult RedirectTo<TController>(this Controller controller, string actionName, object? routeValues = null) => controller.RedirectToAction(actionName, typeof(TController).Name.Replace("Controller", ""), routeValues);

    public static RedirectToActionResult RedirectToReturnTo(this Controller controller, string returnTo, string? childId = null) => returnTo switch
    {
